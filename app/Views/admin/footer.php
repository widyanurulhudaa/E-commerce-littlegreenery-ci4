  ...
  <div class="row align-items-center justify-content-lg-between">
    <div class="col-lg-6">
      <div class="copyright text-center text-lg-left text-muted">
        ...
        </script> <a href="#" class="font-weight-bold ml-1" target="_blank"><?php echo get_store_name(); ?></a>
      </div>
    </div>
  </div>
</footer>
...
<!-- Argon JS -->
<script src=<?= base_url('assets/themes/argon/js/argon9f1e.js?v=1.1.0'); ?>></script>
</body>
