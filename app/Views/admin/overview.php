            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0">Rp <?php echo $total_income; ?></span>
                </div>
                <div class="col-auto">
              ...
              <li class="checklist-entry list-group-item flex-column align-items-start py-4 px-4">
                <div class="checklist-item checklist-item-info">
                  <div class="checklist-info">
                    ...
                    <small><?php echo $order->total_items; ?></small> | <small>Rp <?php echo $order->total_price; ?></small>
                  </div>
                </div>
              </li>
            <?php endforeach; ?>
              ...
              <li class="list-group-item px-0">
                <div class="row align-items-center">
                  ...
                  <div class="col">
                    ...
                    <div>
                      Rp <?php echo $payment->payment_price; ?>
                    </div>
                  </div>
                </div>
              </li>
