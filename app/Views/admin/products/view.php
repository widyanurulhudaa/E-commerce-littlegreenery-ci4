...
<div class="container-fluid mt--6">
      ...
      <div class="card-wrapper">
        <div class="card">
          ...
          <div class="card-body p-0">
            ...
            <table class="table table-hover table-striped">
              ...
              <tr>
                <td>Kategori</td>
                <td>:</td>
                <td><b><?php echo anchor('admin_products?category_id=' . $product->category_id, $product->category_name); ?></b></td>
              </tr>
              <tr>
                <td>Stok / Satuan</td>
                <td>:</td>
          ...
          <div class="card-footer text-right">
            <a href="<?php echo base_url('admin_products/edit/' . $product->id); ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
  ...
  <script>
    $('#deleteProductForm').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo base_url('admin_products/product_api?action=delete_product'); ?>',
        data: data,
        success: function(res) {
          if (res.code == 204) {
            ...
            setTimeout(function() {
              window.location = '<?php echo base_url('admin_products'); ?>';
            }, 6000);
          } else {
