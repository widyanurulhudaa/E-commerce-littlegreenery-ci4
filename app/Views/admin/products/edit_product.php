        ...
        <div class="col-lg-6 col-5 text-right">
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin_products/view/' . $product->id); ?>"><?php echo $product->name; ?></a></li>
...
<div class="container-fluid mt--6">
  <?php echo form_open_multipart('admin_products/edit_product'); ?>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('category_id'); ?></div>
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('price'); ?></div>
                  </div>
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('price_discount'); ?></div>
                  </div>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('stock'); ?></div>
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('unit'); ?></div>
            ...
            <div class="form-group">
              ...
              <textarea name="desc" class="form-control" id="desc"><?php echo set_value('desc', $product->description); ?></textarea>
              <div class="form-error text-danger font-weight-bold"> <?= $validation->getError('desc'); ?></div>
  ...
  <script>
    $('.deletePictureBtn').click(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo base_url('admin_products/product_api?action=delete_image'); ?>',
        data: {
